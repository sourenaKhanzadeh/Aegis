...
class GasOptimizationDetector(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/crytic/slither/wiki/Detector-Documentation#gas-optimization"
    )
    WIKI_TITLE = "Gas Optimization"
    WIKI_DESCRIPTION = (
        "Identifies code patterns that could be optimized for gas efficiency."
    )
    ...
    def _check_function_optimizations(self, function):
        ...
        for param in function.parameters:
            ...
            if (
                "[]" in param_type_str
                and "memory" in param_type_str
                and function.visibility == "external"
            ):
